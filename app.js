...
var demoWorkspace = Blockly.inject('blocklyDiv',
    ...
    function initApi(interpreter, globalObject) {
      ...
      interpreter.setProperty(globalObject, 'goright',
          interpreter.createNativeFunction(wrapper));

     var wrapper = function() {
        moveleft();
      };
      interpreter.setProperty(globalObject, 'goleft',
          interpreter.createNativeFunction(wrapper));

    var wrapper = function() {
        moveup();
      };
      interpreter.setProperty(globalObject, 'goup',
          interpreter.createNativeFunction(wrapper));

    var wrapper = function() {
        movedown();
      };
      interpreter.setProperty(globalObject, 'godown',
          interpreter.createNativeFunction(wrapper));
